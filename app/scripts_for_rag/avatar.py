...
def _authenticate():
    if PASSWORDLESS_AUTHENTICATION:
        ...
        SUBSCRIPTION_KEY = os.getenv("SUBSCRIPTION_KEY", '9EnXtKOJAibQ6SecsO2ElXZuP8aYTtWplHkv4TRZ8BdHk1nanYsKJQQJ99ALACHYHv6XJ3w3AAAEACOGEO7L')
...
def submit_synthesis(job_id: str):
    ...
    payload = {
        ...
        "avatarConfig":
        {
            ...
            "talkingAvatarCharacter": 'Meg-business',  # talking avatar character
        ...
        {
        "customized": isCustomized, # set to True if you want to use customized avatar
        "talkingAvatarCharacter": 'Meg',  # talking avatar character
